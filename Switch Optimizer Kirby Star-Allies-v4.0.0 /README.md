...
**Graficos:** Poner Vulkan Obligatoriamente (Sobretodo En Graficas Integradas) MUY IMPORTANTE, En NVDEC Emulation Pon En CPU Video Decoding (Si No EL Juego Ira Mal) En Resolution Pon Recomendamos Poner 1x para abajo (Ya que si subes el escalado a mas de 2x el juego se bugueara)
